...
/* Defines  ------------------------------------------------------------------*/
#define INFO_TEXT_FLANCO_DESCENDENTE "Se produjo flanco descendente\n"
#define INFO_TEXT_FLANCO_ASCENDENTE "Se produjo flanco ascendente\n"
...
/**
  ...
  * 		por default y la inicializacion de la UART
  * @param  None
  * @retval None
  */
...
/**
  * @brief  Funcion que ejecuta accion si se presiona el boton de usuario. Se envia mensaje por UART
  * @param  None
  * @retval None
  */
void buttonPressed(void){

	uint8_t textToSend[] = INFO_TEXT_FLANCO_DESCENDENTE;
...
/**
  * @brief  Funcion que realiza accion de cambiar variable global privada de boton presionado. Se envia mensaje por UART
  * @param  None
  * @retval None
  */
...
void buttonReleased(void){
	...
	uint8_t textToSend[] = INFO_TEXT_FLANCO_ASCENDENTE;
